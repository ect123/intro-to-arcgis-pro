...
What you have just done is reassigned the coordinate system of the **Map Frame** to that of the **Mother Tongue Layer**. The result of this change should be a substantial change to the view on the Map.
...
### Zoom to layer
Sometimes it is very helpful to see the entirety of a layer's extent. To fit the **Language Spoken at Home** layer into the **Map Frame**:
- Right-click on the **Language Spoken at Home** layer, in the Contents Panel, and select Zoom to Layer.
